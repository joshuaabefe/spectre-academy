...
Spectre Academy Admission Portal is a responsive frontend project for managing student admission applications through a polished multi-step form experience.
...
- Colour palette link: [`docs/COLOR-PALETTE.md`](./docs/COLOR-PALETTE.md)

## Project Files

- Main page: [`index.html`](./index.html)
- Styles: [`style.css`](./style.css)
- Interactions: [`script.js`](./script.js)
- Branding assets: [`assets/`](./assets)

## Live Deployment

To create the final live link quickly with GitHub Pages:
